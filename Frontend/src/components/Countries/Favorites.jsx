    ...
    return (
      <Container
        ...
        sx={{
          ...
          px: { xs: 2, sm: 3 }, // Custom padding that's more compact
        }}
      >
        <motion.div
  ...
  return (
    <Container
      ...
      sx={{
        py: 2,
        minHeight: "calc(100vh - 64px)",
        px: { xs: 2, sm: 3, md: 4 }, // Custom padding that's more compact
      }}
    >
      <motion.div
        initial={{ opacity: 0, y: 20 }}
      ...
      >
        ...
        <Grid container spacing={2}>
          ...
          <Grid item xs={12} md={6} lg={5} sx={{ pl: { md: 0 } }}>
            <Box sx={{ mb: 2 }}>
          ...
          <Grid item xs={12} md={6} lg={7} sx={{ pr: { md: 0 } }}>
